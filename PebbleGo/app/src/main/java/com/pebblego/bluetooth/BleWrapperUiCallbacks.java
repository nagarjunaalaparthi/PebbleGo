...
public interface BleWrapperUiCallbacks {
	...
	public void uiDeviceDisconnected(final BluetoothGatt gatt, final BluetoothDevice device, final boolean bUnexpected);
	...
	public void uiNewValueForCharacteristic(final BluetoothGatt gatt, final BluetoothDevice device, final BluetoothGattService service, final BluetoothGattCharacteristic ch, final String strValue,
											final int intValue, final byte[] rawValue, final String timestamp);
	...
	public static class Null implements BleWrapperUiCallbacks {
		...
		@Override
		public void uiDeviceDisconnected(BluetoothGatt gatt, BluetoothDevice device, boolean bUnexpected) {
		}
		...
		@Override
		public void uiNewValueForCharacteristic(BluetoothGatt gatt, BluetoothDevice device, BluetoothGattService service, BluetoothGattCharacteristic ch, String strValue, int intValue,
